...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        YIELDMAX_INFO = {
            'TSLY': {'Underlying': 'TSLA', 'Strategy': 'Bullish'},
            'NVDY': {'Underlying': 'NVDA', 'Strategy': 'Bullish'},
            'MSTY': {'Underlying': 'MSTR', 'Strategy': 'Bullish'},
            'APLY': {'Underlying': 'AAPL', 'Strategy': 'Bullish'},
            'AMZY': {'Underlying': 'AMZN', 'Strategy': 'Bullish'},
            'GOOY': {'Underlying': 'GOOGL', 'Strategy': 'Bullish'},
            'NFLY': {'Underlying': 'NFLX', 'Strategy': 'Bullish'},
            'MSFO': {'Underlying': 'MSFT', 'Strategy': 'Bullish'},
            'FBY':  {'Underlying': 'META', 'Strategy': 'Bullish'},
            'JPMO': {'Underlying': 'JPM', 'Strategy': 'Bullish'},
            'DISO': {'Underlying': 'DIS', 'Strategy': 'Bullish'},
            'PYPY': {'Underlying': 'PYPL', 'Strategy': 'Bullish'},
            'ABNY': {'Underlying': 'ABNB', 'Strategy': 'Bullish'},
            'AMDY': {'Underlying': 'AMD', 'Strategy': 'Bullish'},
            'SNOY': {'Underlying': 'SNOW', 'Strategy': 'Bullish'},
            'XOMO': {'Underlying': 'XOM', 'Strategy': 'Bullish'},
            'PLTY': {'Underlying': 'PLTR', 'Strategy': 'Bullish'},
            'CVNY': {'Underlying': 'CVNA', 'Strategy': 'Bullish'},
            'MARO': {'Underlying': 'MARA', 'Strategy': 'Bullish'},
            'MRNY': {'Underlying': 'MRNA', 'Strategy': 'Bullish'},
            'AIYY': {'Underlying': 'AI', 'Strategy': 'Bullish'},
            'HOOY': {'Underlying': 'HOOD', 'Strategy': 'Bullish'},
            'CONY': {'Underlying': 'COIN', 'Strategy': 'Bullish'},
            'BABO': {'Underlying': 'BABA', 'Strategy': 'Bullish'},
            'GDXY': {'Underlying': 'GDX', 'Strategy': 'Bullish'},
            'YBIT': {'Underlying': 'BTC-USD', 'Strategy': 'Bullish'},
            'FIAT': {'Underlying': 'COIN', 'Strategy': 'Bearish'},
            'DIPS': {'Underlying': 'NVDA', 'Strategy': 'Bearish'},
            'CRSH': {'Underlying': 'TSLA', 'Strategy': 'Bearish'},
            'YQQQ': {'Underlying': 'QQQ', 'Strategy': 'Bearish'},
            'CHPY': {'Underlying': 'Multiple', 'Strategy': 'Bullish'},
            'GPTY': {'Underlying': 'Multiple', 'Strategy': 'Bullish'},
